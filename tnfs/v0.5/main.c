/* NABU CP/M TNFS client v0.5 by GTAMP (c) 2026
...
/* -----------------------------------------------------------------------
   ...
   ----------------------------------------------------------------------- */
#define STR_VERSION       "TNFS v0.5"
#define STR_TITLE         "NABU TNFS v0.5 by GTAMP"
...
#define STR_SUBMIT_FILE   "A:$$$.SUB"
#define STR_TEMP_COM      "TNFSTEMP.COM"
#define STR_TEMP_SUB      "A:TNFSTEMP"
