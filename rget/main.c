/*
 * RetroNet Get (RGET) v0.3 by GTAMP (c) 2026
...
void main() {
    ...
    printf("RetroNet Get v0.3 by GTAMP (c) 2026\n");
    printf("Type RGET /? for help\n\n");

    rawUrl[0] = '\0'; rawFile[0] = '\0';

    if (CPM_CMD_LEN > 0) {
        /* Command line is forced to lower by CP/M anyway, but we handle it */
